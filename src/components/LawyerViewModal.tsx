...
export default function LawyerViewModal({
  invitation,
  closeModal,
  cancelButtonRef,
}) {
  // const invitation.id = usePathname().split('/').pop()
  if (!invitation)
    return (
      <div>
          ...
          <div className="w-full">
            ...
            <section aria-labelledby="information-heading" className="mt-4">
              ...
              <div className="flex items-center">
                <p className="text-lg text-gray-900">$500</p>
            ...
            <section aria-labelledby="options-heading">
              ...
              <form className="w-full">
                ...
                {/* <div className="mt-4 flex w-full flex-row items-center gap-4">
                  ...
                  >
                    <div className="flex h-full w-full flex-row gap-4 bg-blue-100">
                      <button
                        type="submit"
                        className="flex h-full w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"
                      >
                        <ShieldCheckIcon
                  ...
                  <button
                    ...
                    onClick={closeModal}
                    ref={cancelButtonRef}
                    className="flex w-1/3 items-center justify-center rounded-md border border-transparent bg-indigo-50 px-8 py-3 text-base font-medium text-indigo-700 hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"
                  >
                    Next
                  </button>
                </div>
        ...
        <section aria-labelledby="details-heading">
          ...
          <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
            <div>
              ...
              <p className="mt-8 text-base text-gray-500">
                <span className="font-bold">First $100 free.</span> Free money,
                why not? We pass as much value back to users as possible.
              </p>
            </div>
            <div>
              <div className="aspect-h-2 aspect-w-3 w-full overflow-hidden rounded-lg">
              ...
              <p className="mt-8 text-base text-gray-500">
                <span className="font-bold">Free Weekly Updates.</span> It's
                your attorney's job to make sure you're up to date. We help make
                sure they do.
              </p>
            </div>
          </div>
          {/* <div className="mt-16 grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-8">
            ...
            <div>
              ...
              <p className="mt-8 text-base text-gray-500">
                <span className="font-bold">First 2 hours free ($1000).</span>{' '}
                It's your attorney's job to make sure you're up to date. We help
                make sure they do.
              </p>
            </div>
          </div> */}
