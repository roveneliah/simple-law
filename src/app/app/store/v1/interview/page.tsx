...
const product = STORE['interview']

export function InterviewProductView({ caseId }) {
  return (
...
export default function InterviewProductPage({ params: { caseId } }) {
  return (
    <AppLayout caseId={caseId}>
      <InterviewProductView caseId={caseId} />
    </AppLayout>
  )
}
