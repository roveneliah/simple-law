      ...
      <form onSubmit={handleSubmit} className="mt-8">
        <div className="space-y-12">
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">
              Tell us about your practice. This is just for us, and will not be
              client facing.
            </p>

            {barMemberships.map((membership, i) => (
              <div
                key={i}
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      onChange={(e) => {
                        setBarMemberships([
                          ...barMemberships.slice(0, i),
                          { ...membership, barNumber: e.target.value },
                          ...barMemberships.slice(i + 1),
                        ])
                      }}
                      value={membership.barNumber}
                      className="block w-full rounded-md border-0 px-3 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      onChange={(e) => {
                        setBarMemberships([
                          ...barMemberships.slice(0, i),
                          { ...membership, jurisdiction: e.target.value },
                          ...barMemberships.slice(i + 1),
                        ])
                      }}
                      value={membership.jurisdiction}
                      className="block w-full rounded-md border-0 px-3 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                ...
                <div className="sm:col-span-3">
                  ...
                  <div className="mt-2">
                    <select
                      ...
                      disabled={true}
                      autoComplete="country-name"
                      className="block w-full rounded-md border-0 px-3 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                    >
